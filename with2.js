...
topup.addEventListener("input", simpleInterest);
Title.addEventListener("change", simpleInterest);
...
function simpleInterest() {
  console.log("yes")
  var principalss = parseFloat(document.getElementById("pamount").value);
  var to = parseFloat(document.getElementById("topup").value);
  var principal = principalss + to ;
  var newp = principal;
  document.getElementById("newprincipal").value =  newp;
